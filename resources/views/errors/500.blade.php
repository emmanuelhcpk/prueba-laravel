...
<head>
    ...
    <title>BlueCoinCompany  | Governance</title>

    <!-- Vendor styles-->

    <link rel="icon" type="image/png" href="{{url('/imagenes/blue-01.png')}}" />
                    ...
                    <div class="error-template">
                        ...
                        <center>
                            ...
                            <div class="error-details">
                                ...
                                Lo sentimos , la pagína no ha sido encontrado!

                            </div>

                            <div class="error-actions">

                                <a href="{{url('home')}}" class="btn btn-primary btn-lg"><span

                                            class="glyphicon glyphicon-home"></span>

                                    Llevame a casa! </a><a href="http://Pasarela.co" class="btn btn-default btn-lg"><span

                                            class="glyphicon glyphicon-envelope"></span> Soporte Tecnico</a>
